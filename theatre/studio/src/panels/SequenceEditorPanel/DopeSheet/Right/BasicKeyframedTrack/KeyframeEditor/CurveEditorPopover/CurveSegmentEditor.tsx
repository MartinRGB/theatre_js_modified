...
const CURVE_START_OVERSHOOT_COLOR = '#0768cf'
const CURVE_START_COLOR = '#0768cf'
const CURVE_MID_START_COLOR = '#0768cf'
const CURVE_MID_COLOR = '#0768cf'
const CURVE_MID_END_COLOR = '#0768cf'
const CURVE_END_COLOR = '#0768cf'
const CURVE_END_OVERSHOOT_COLOR = '#0768cf'

const CONTROL_COLOR = '#B3B3B3'
const HANDLE_COLOR = '#0768cf' // #3EAAA4
const HANDLE_HOVER_COLOR = '#0d99ff'
